...
msg_types = {
    ...
    (CLASS_NAV, MSG_NAV_RELPOSNED): UBloxDescriptor('NAV_RELPOSNED',
                                                  '<BBHIiiibbbBIIII',
                                                  ['version', 'reserved1', 'refStationId', 'iTow', 'relPosN', 'relPosE', 'relPosD',
                                                   'relPosHPN', 'relPosHPE', 'relPosHPD', 'reserved2', 'accN', 'accE', 'accD', 'flags']),
    ...
    (CLASS_RXM, MSG_RXM_RTCM)   : UBloxDescriptor('RXM_RTCM',
                                                  '<BB2BHH',
                                                  ['version', 'flags', 'reserved1[2]', 'refStation', 'msgType']),
    ...
    (CLASS_RXM, MSG_RXM_RAWX)   : UBloxDescriptor('RXM_RAWX',
                                                  ...
                                                  'numMeas',
                                                  '<ddfBBBBHBBBBBB',
                                                  ['prMes', 'cpMes', 'doMes', 'gnssId', 'svId', 'reserved2', 'freqId', 'locktime',
                                                   'cno', 'prStdev', 'cpStdev', 'doStdev', 'trkStat', 'reserved3']),
